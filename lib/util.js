...
async function generatorProject({
	name,
	pkg,
	template
}) {
	...
	writeFileSync(resolve(userRootPath, `./package.json`), JSON.stringify(pkg, null, 2), {
		encoding: 'utf-8'
	});
	writeFileSync(resolve(userRootPath, `./.npmrc`), 
